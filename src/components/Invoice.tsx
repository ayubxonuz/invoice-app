    ...
    <Link to={`/invoice/${data.id}`}>
      <div className="max-w-full border border-white hover:border-[#48549F] transition rounded-lg max-[760px]:px-6 py-4 mb-4 w-full dark:bg-[#1E2139] dark:border-[#1E2139] bg-white px-8">
        <div className="flex items-center h-full">
          <div className="flex max-[760px]:block h-full items-center gap-x-11">
            ...
            <div className="flex gap-x-12 max-[760px]:block items-center">
              <p className="text-xs w-16 max-[760px]:w-full inline-grid dark:text-[#DFE3FA] text-start  text-[#888EB0]  tracking-[-0.25px]">
                {data.paymentDue}
              </p>
